            ...
            {results.map((r, i) => (
              <tr key={i} className="hover:bg-slate-50">
                ...
                <td className="px-4 py-4 space-x-2 text-xs font-semibold">
                  {r.facebook !== "N/A" && <a href={r.facebook} target="_blank" rel="noreferrer" className="text-blue-600">FB</a>}
                  {r.linkedin !== "N/A" && <a href={r.linkedin} target="_blank" rel="noreferrer" className="text-blue-700">IN</a>}
                  {r.instagram !== "N/A" && <a href={r.instagram} target="_blank" rel="noreferrer" className="text-pink-600">IG</a>}
                </td>
              </tr>
            ))}
          </tbody>
